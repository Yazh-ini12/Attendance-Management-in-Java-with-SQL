...
public class StudentView {
	...
	public void stView(int id) throws SQLException {
		...
		totalclass.setForeground(Color.white);
		...
		ttbox.setForeground(Color.white);
		...
		AttPer.setForeground(Color.white);
